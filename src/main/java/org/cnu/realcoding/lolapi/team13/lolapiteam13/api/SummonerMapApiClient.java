...
public class SummonerMapApiClient {
    ...
    private final ParameterizedTypeReference<Set<Summoner>> responseType = new ParameterizedTypeReference<Set<Summoner>>() {};
    ...
    public Set<Summoner> getSummonerInfo(String SummonerIdString){
        ...
        Set<Summoner> getSummonerSet = restTemplate.exchange(requestUrl, HttpMethod.GET, null, responseType, encryptedSummonerId, apiKey).getBody();
